...
public final class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener,
    ...
    /**
     * <p>
     * Determines if this turtle approximately collides with another turtle using approximate rectangular hitboxes.
     * </p>
     * 
    ...
    /**
     * <p>
     * Determines if this turtle approximately collides with another turtle using approximate hitboxes.
     * - If circular is true, uses two circles to determine collision.
     * - Else, uses two rectangles to determine collision.
     * 
     * Both collision detection methods center the shape at the turtle's location and uses the turtle's shape 
     * width and height multiplied by the scale factor to determine the size of the shape.
     * 
     * </p>
     * 
     * @param other the turtle to check collision with
     * @param circular if true, uses circular collision detection. If false, uses rectangular collision detection.
     * @return true if the turtles collide, false otherwise
     */
